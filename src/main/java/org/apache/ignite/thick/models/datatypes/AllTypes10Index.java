 ...
 */
public class AllTypes10Index extends Timestamped {
    /**
     * Data Long.
     */
     ...
     */
    @QuerySqlField(index = true)
    public Long longCol1;

    /**
     * Data double 1.
     */
    @QuerySqlField(index = true)
    public double doubleCol1;

    /**
     * Data String 1.
     */
    @QuerySqlField(index = true)
    public String stringCol1;
    ...
    private void init(Long key, String str) {
        ...
        longCol1 = key;
        doubleCol1 = Math.round(1000 * Math.log10(longCol.doubleValue()));
    ...
    public AllTypes10Index(Long key) {
        init(key, Long.toString(key));
    }

    public AllTypes10Index(Long key, String str) {
        init(key, str);
    }
